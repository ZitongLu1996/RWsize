...
save_features(features, out_path='cornet_late_features', file_format='npy')

import numpy as np

features = np.load('cornet_late_features/features.npy')
print(features)
...
np.save('ann_rdms/cornet_late.npy', rdm_dnn)
...
save_features(features, out_path='cornet_early_features', file_format='npy')

import numpy as np

features = np.load('cornet_early_features/features.npy')
print(features)
...
np.save('ann_rdms/cornet_early.npy', rdm_dnn)
