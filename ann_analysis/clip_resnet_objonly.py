...
dataset = ImageDataset(
  root=root,
  out_path='clip_resnet_features_objonly',
...
save_features(features, out_path='clip_resnet_late_features_objonly', file_format='npy')

import numpy as np

features = np.load('clip_resnet_late_features_objonly/features.npy')
print(features)
...
np.save('ann_rdms/clip_resnet_late_objonly.npy', rdm_dnn)
...
save_features(features, out_path='clip_resnet_early_features_objonly', file_format='npy')

import numpy as np

features = np.load('clip_resnet_early_features_objonly/features.npy')
print(features)
...
np.save('ann_rdms/clip_resnet_early_objonly.npy', rdm_dnn)
