...
dataset = ImageDataset(
  root=root,
  out_path='cornet_features_bgonly',
...
save_features(features, out_path='cornet_late_features_bgonly', file_format='npy')

import numpy as np

features = np.load('cornet_late_features_bgonly/features.npy')
print(features)
...
np.save('ann_rdms/cornet_late_bgonly.npy', rdm_dnn)
...
save_features(features, out_path='cornet_early_features_bgonly', file_format='npy')

import numpy as np

features = np.load('cornet_early_features_bgonly/features.npy')
print(features)
...
np.save('ann_rdms/cornet_early_bgonly.npy', rdm_dnn)
