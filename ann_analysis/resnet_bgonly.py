...
dataset = ImageDataset(
  root=root,
  out_path='resnet_features_bgonly',
...
save_features(features, out_path='resnet_late_features_bgonly', file_format='npy')

import numpy as np

features = np.load('resnet_late_features_bgonly/features.npy')
print(features)
...
np.save('ann_rdms/resnet_late_bgonly.npy', rdm_dnn)
...
save_features(features, out_path='resnet_early_features_bgonly', file_format='npy')

import numpy as np

features = np.load('resnet_early_features_bgonly/features.npy')
print(features)
...
np.save('ann_rdms/resnet_early_bgonly.npy', rdm_dnn)
