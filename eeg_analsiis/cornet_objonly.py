...
dataset = ImageDataset(
  root=root,
  out_path='cornet_features_objonly',
...
save_features(features, out_path='cornet_late_features_objonly', file_format='npy')

import numpy as np

features = np.load('cornet_late_features_objonly/features.npy')
print(features)
...
np.save('ann_rdms/cornet_late_objonly.npy', rdm_dnn)
...
save_features(features, out_path='cornet_early_features_objonly', file_format='npy')

import numpy as np

features = np.load('cornet_early_features_objonly/features.npy')
print(features)
...
np.save('ann_rdms/cornet_early_objonly.npy', rdm_dnn)
