...
save_features(features, out_path='resnet_late_features', file_format='npy')

import numpy as np

features = np.load('resnet_late_features/features.npy')
print(features)
...
np.save('ann_rdms/resnet_late.npy', rdm_dnn)
...
save_features(features, out_path='resnet_early_features', file_format='npy')

import numpy as np

features = np.load('resnet_early_features/features.npy')
print(features)
...
np.save('ann_rdms/resnet_early.npy', rdm_dnn)
